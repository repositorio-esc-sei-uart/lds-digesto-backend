...
/**
 * Controlador REST para gestionar las peticiones HTTP relacionadas con
 * Documentos. Actúa como la puerta de entrada a la API para el módulo de
 * documentos, delegando la lógica de negocio al DocumentoService.
 *
 * @author micael
 * @author Quique
 */
...
public class DocumentoController {
    ...
    /**
     * Endpoint para OBTENER una lista RESUMIDA de todos los documentos. Utiliza
     * un DTO "ligero" (DocumentoTablaDTO) optimizado para tablas.
     *
     ...
     * en el N° Documento.
     * @param idTipoDocumento (Búsqueda Avanzada/Simple) Filtra por el ID del
     * Tipo de Documento.
     * @param idSector (Búsqueda Avanzada) Filtra por el ID del Sector.
     * @param idEstado (Búsqueda Avanzada) Filtra por el ID del Estado.
     * @param fechaDesdeStr (Búsqueda Avanzada) Rango de fecha de creación
     * (inicio).
     * @param fechaHastaStr (Búsqueda Avanzada) Rango de fecha de creación
     * (fin).
     * @param excluirPalabras (Búsqueda Avanzada) Filtra excluyendo palabras en
     * todos los campos.
    ...
    /**
     * Endpoint para OBTENER un documento específico por su ID. Devuelve el DTO
     * "completo" (DocumentoDTO) con todos sus detalles y relaciones.
     *
    ...
    /**
     * Endpoint para CREAR un nuevo documento. Recibe un DTO con los datos del
     * documento y sus relaciones (IDs).
     *
    ...
    /**
     * Endpoint para ACTUALIZAR un documento existente. Responde a peticiones
    ...
    /**
     * Endpoint para ELIMINAR un documento por su ID. Responde a peticiones
    ...
    /**
     * Endpoint para obtener el conteo de documentos por tipo. Responde a GET
     * /api/v1/documentos/count-by-type
     *
